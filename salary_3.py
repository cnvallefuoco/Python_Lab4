...
print("This program will calculate for a single starting salary and a certain number of years at a job,"
      ...
      "\nand a yearly salary increase of 3%.")
...
# Use the while loop to add a 3% increase in salary to each year with a starting salary as the base.
